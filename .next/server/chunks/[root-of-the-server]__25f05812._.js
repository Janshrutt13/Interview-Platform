...
async function POST(request) {
    try {
        ...
        if (!workflowId && !assistant) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: "Provide either workflowId or assistant"
            }, {
                status: 400
            });
        }
        ...
        if (!res.ok) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: data?.error?.message || data?.message || "Vapi call failed"
            }, {
                status: res.status
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__25f05812._.js.map