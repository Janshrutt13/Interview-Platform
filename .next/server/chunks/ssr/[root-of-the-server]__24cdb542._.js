...
const Agent = ({ userName, userId, interviewId, feedbackId, type, questions })=>{
    ...
    const handleCall = async ()=>{
        ...
        if (type === "generate") {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vapi$2e$sdk$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vapi"].start(undefined, undefined, undefined, ("TURBOPACK compile-time value", "49e9943b-8ccb-423b-9297-90166d67015c"), {
                variableValues: {
                    username: userName,
                    userid: userId
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__24cdb542._.js.map