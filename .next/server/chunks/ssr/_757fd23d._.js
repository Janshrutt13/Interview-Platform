...
"[project]/lib/actions/data:b79f20 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
function InterviewStrategist({ userName, userId }) {
    ...
    const handleGenerate = async ()=>{
        ...
        setError("");
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$data$3a$b79f20__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["generateInterviewDossier"])({
...
//# sourceMappingURL=_757fd23d._.js.map