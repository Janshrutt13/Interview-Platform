...
"[project]/lib/actions/data:a8a6fb [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$data$3a$a8a6fb__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/actions/data:a8a6fb [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
...
function InterviewStrategist({ userName, userId }) {
    ...
    const handleGenerate = async ()=>{
        ...
        setError("");
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$data$3a$a8a6fb__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["generateInterviewDossier"])({
...
//# sourceMappingURL=_b6ca63ee._.js.map